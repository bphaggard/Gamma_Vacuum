...
from logging_setup import attach_measurement_log, detach_measurement_log
...
class PressureViewer(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Reference & base_lines (lazy init)
    ...
    def update_filename(self):
        ...
        attach_measurement_log(filename)
        logger.info("CSV file set to %s", filename)
        ...
        if timestamps:
            ...
            logger.info("Recovered %d existing records from %s",
    ...
    def view_old_data(self):
        ...
        logger.info("Loaded historical data from %s (%d records)",
    ...
    def start_monitor(self):
        ...
        logger.info("Start monitoring requested (file=%s)", self.active_file)
    ...
    def _on_thread_finished(self):
        ...
        logger.debug("Worker thread finished, UI re-enabled")
    ...
    def _on_worker_error(self, message: str):
        ...
        logger.warning("Worker reported recoverable error: %s", message)
    ...
    def _on_connection_lost(self, message: str):
        ...
        logger.error("Worker reported connection lost: %s", message)
    ...
    def closeEvent(self, event):
        ...
        if self._is_monitoring():
            try:
                ...
                logger.exception("Error stopping worker on close")
